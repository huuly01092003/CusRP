...
<head>
    ...
    <title>Import Báo cáo Khách hàng</title>
            ...
            <div class="col-md-8">
                <div class="import-card">
                    <div class="card-header">
                        <h3 class="mb-0"><i class="fas fa-file-import me-2"></i>Import Dữ liệu Báo cáo</h3>
                    </div>
                        ...
                        <form method="POST" action="index.php?action=upload" enctype="multipart/form-data" id="uploadForm">
                            <div class="mb-4">
                                <label class="form-label fw-bold">
                                    <i class="fas fa-calendar-alt me-2"></i>Tháng/Năm báo cáo
                                </label>
                                <input type="text" name="thang_nam" class="form-control form-control-lg" 
                                       placeholder="VD: 11/2025" pattern="\d{2}/\d{4}" required>
                                <small class="text-muted">Định dạng: MM/YYYY</small>
                            </div>
